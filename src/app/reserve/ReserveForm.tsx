...
export default function ReserveForm() {
  ...
  return (
    <div className="max-w-lg mx-auto px-4 py-4">
      {/* LINE未経由の場合：LIFF誘導バナー */}
      {!isInLine && step === 0 && (
        <div className="mb-3 bg-[#06C755]/10 border border-[#06C755]/30 rounded-2xl p-4">
          <p className="text-sm font-bold text-gray-800 mb-1">LINEから予約すると便利です</p>
          <p className="text-xs text-gray-600 mb-3">
            予約確認・リマインドがLINEに届きます。まずは友だち追加してください。
          </p>
          <div className="flex gap-2">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex-1 flex items-center justify-center gap-1.5 py-2.5 bg-[#06C755] text-white text-xs font-bold rounded-xl hover:bg-[#05b04c] transition-colors"
            >
            ...
            <a
              ...
              className="flex-1 flex items-center justify-center gap-1.5 py-2.5 bg-white border-2 border-[#06C755] text-[#06C755] text-xs font-bold rounded-xl hover:bg-[#06C755]/5 transition-colors"
            >
              LINEで予約する
            </a>
          </div>

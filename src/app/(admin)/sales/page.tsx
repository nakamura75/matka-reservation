import { getReservations, getStaff, getPlans, getOptions, getReservationOptions } from '@/lib/google-sheets';
import SalesSummary from './SalesSummary';

export const dynamic = 'force-dynamic';

export default async function SalesPage() {
  const [reservations, staff, plans, options, reservationOptions] = await Promise.all([
  ...
  return (
    <div>
      ...
      <SalesSummary reservations={enrichedReservations} staff={staff} />
    </div>
  );
}

...
import { SHOOTING_SCENES, SCENE_PLAN_MAP, LINE_OA_ID } from '@/lib/constants';
...
// メインコンポーネント
// ============================================================
export default function StudioForm({ lineUserId = '', lineName = '', isInLine }: { lineUserId?: string; lineName?: string; isInLine?: boolean }) {
